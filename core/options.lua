      ...
      args = {
        ...
        eyeofthestorm = {
          ...
          args = {
            enabled = {
              name = "Enabled",
              desc = "Enable for Eye of the Storm",
              type = "toggle",
              width = "normal",
              order = 1,
              disabled = false,
        ...
        silvershardmines = {
          ...
          args = {
            enabled = {
              name = "Enabled",
              desc = "Enable for Silvershard Mines",
              type = "toggle",
              width = "normal",
              order = 1,
              disabled = false,
        ...
        templeofkotmogu = {
          ...
          args = {
            enabled = {
              name = "Enabled",
              desc = "Enable for Temple of Kotmogu",
              type = "toggle",
              width = "normal",
              order = 1,
              disabled = false,
        ...
        thebattleforgilneas = {
          ...
          args = {
            enabled = {
              name = "Enabled",
              desc = "Enable for The Battle for Gilneas",
              type = "toggle",
              width = "normal",
              order = 1,
              disabled = false,
